...
func main() {
	...
	actorManager.Add(sactor.NewEnsureResourceActor(clientset, mgr.GetLogger()))
	actorManager.Add(sactor.NewSentinelHealActor(clientset, mgr.GetLogger()))
	actorManager.Add(sactor.NewActorHealMasterActor(clientset, mgr.GetLogger()))
	actorManager.Add(sactor.NewActorInitMasterActor(clientset, mgr.GetLogger()))
	actorManager.Add(sactor.NewSentinelUpdateConfig(clientset, mgr.GetLogger()))
	actorManager.Add(sactor.NewPatchLabelsActor(clientset, mgr.GetLogger()))
	actorManager.Add(sactor.NewUpdateAccountActor(clientset, mgr.GetLogger()))
	actorManager.Add(cactor.NewCleanResourceActor(clientset, mgr.GetLogger()))
	actorManager.Add(cactor.NewEnsureResourceActor(clientset, mgr.GetLogger()))
	actorManager.Add(cactor.NewEnsureSlotsActor(clientset, mgr.GetLogger()))
	actorManager.Add(cactor.NewHealPodActor(clientset, mgr.GetLogger()))
	actorManager.Add(cactor.NewJoinNodeActor(clientset, mgr.GetLogger()))
	actorManager.Add(cactor.NewRebalanceActor(clientset, mgr.GetLogger()))
	actorManager.Add(cactor.NewUpdateConfigActor(clientset, mgr.GetLogger()))
	actorManager.Add(cactor.NewUpdateAccountActor(clientset, mgr.GetLogger()))
