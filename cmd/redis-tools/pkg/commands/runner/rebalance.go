...
func RebalanceSlots(ctx context.Context, authInfo redis.AuthInfo, address string, logger logr.Logger) error {
	...
	client := redis.NewClient(address, authInfo)
	defer client.Close()
...
func importSlots(ctx context.Context, nodes redis.Nodes, currentNode, sourceNode *redis.Node, client, sourceClient redis.Client, slotId int, authInfo redis.AuthInfo, logger logr.Logger) error {
...
func isClusterStateOk(ctx context.Context, cli redis.Client) (bool, error) {
