	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.s.IsFullfilled(); got != tt.wantFullfill {
				t.Errorf("Slots.IsFullfilled() = %v, want %v, %v", got, tt.wantFullfill, tt.s.String())
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.s.Inter(tt.args.n); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("Slots.Inter() = %v, want %v", got.String(), tt.want.String())
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.s.Equals(tt.args.old); got != tt.want {
				t.Errorf("Slots.Equals() = %v, want %v %v %v", got, tt.want, tt.s.String(), tt.args.old.String())
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if gotRet := tt.s.String(); !reflect.DeepEqual(gotRet, tt.wantRet) {
				t.Errorf("Slots.String() = %v, want %v", gotRet, tt.wantRet)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.s.Sub(tt.args.n); !reflect.DeepEqual(got.data, tt.want.data) {
				t.Errorf("Slots.Sub() = %v, want %v", got.String(), tt.want.String())
			}
		})
	}
}
...
func TestSlots_Count(t *testing.T) {
	slots := NewSlots()
	_ = slots.Load([]string{"1-100", "1002-<-67ed2db8d677e59ec4a4cefb06858cf2a1a89fa1", "77->-e7d1eecce10fd6bb5eb35b9f99a514335d9ba9ca"})
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if gotC := tt.slots.Count(tt.args.status); gotC != tt.wantC {
				t.Errorf("Slots.Count() = %v, want %v. %v", gotC, tt.wantC, tt.slots.String())
			}
		})
	}
}
