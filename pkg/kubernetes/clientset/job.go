...
func (c *JobOption) CreateJob(ctx context.Context, namespace string, job *v1.Job) error {
	...
	c.logger.WithValues("namespace", namespace, "Job", job.ObjectMeta.Name).Info("Job created")
	return err
}
...
func (c *JobOption) UpdateJob(ctx context.Context, namespace string, job *v1.Job) error {
	...
	c.logger.WithValues("namespace", namespace, "Job", job.ObjectMeta.Name).Info("Job updated")
	return nil
}
